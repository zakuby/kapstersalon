  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active" ><a href="<?php echo base_url(); ?>Salon3/Admin/index">Dashboard <span class="sr-only">(current)</span></a></li>
...
<body id="page-top" class="index">
		...
		<div class="box-body centerbox">
            ...
            <div class="parent-product col-lg-12"><div class="col-lg-10"><select onchange="pilih_produk(this);" class="pilihan-produk form-control kapsterSelection" id="pilihan-produks"> 
			<option value=""></option>
			    <?php
...
function submitSell(e){
	...
	if(kapsterArrID!=""){
		$.post("<?php echo base_url(); ?>Salon3/Admin/tambah_transaksi",
		{
