  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="active"><a href="<?php echo base_url(); ?>Salon3/Admin/report_cashier">Report Cashier</a></li>
      </ul>
...
<body id="page-top" class="index">
     <div class="form-group">
	  ...
	  <h3>Report Cashier</h3><h5 class="text-right"><?php echo "Time Server " . date("d F Y") . "<br>";?></h5>
		...
		<form name="formlist" method="post" action="<?php echo base_url(); ?>Salon3/Admin/list_transaksi_cashier">
		...
		<table id="example2" class="table ">
			...
			print '</td><td></td></tr>';
            ?></tbody></table><a href="<?php echo base_url(); ?>Salon3/Admin/createPDFCashier" class="btn btn-primary pull-right" id="cmd"  target="_blank">Save PDF</a>
		</div>
      </div>
    </div>
</body>
