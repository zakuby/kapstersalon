	  ...
	  <div class="box-body centerbox">
			<?php
				foreach ($k as $kapster) {
					echo "<form method='post' action='".site_url('Salon3/Admin/updateKapster/'.$kapster->id_kapster)."')'>";
				}
			?>
			...
			<div class="col-lg-1 pull-right">
				<a href="<?php echo base_url(); ?>Salon3/Admin/list_kapster" class="btn btn-primary" >Cancel</a>
			</div>
		</form>
