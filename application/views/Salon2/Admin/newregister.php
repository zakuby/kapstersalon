...
<body id="page-top" class="index">
     <div class="form-group">
      ...
      <div class="col-lg-11"><h3>Register Product</h3><h5 class="text-right"><?php echo "Time Server " . date("d F Y") . "<br>";?></h5><div class="box-body centerbox">
        <div class="radio">
          <label>
            <input type="radio" name="optionsRadios" id="optionsRadios1" value="option2" onchange="update()">
            Input Kapster
          </label>
        </div>
        <div class="radio">
		...
		<div id="tujuan">
			<form method="post" action="<?php echo base_url(); ?>Salon2/Admin/tambah_produk">
				<div class="form-group">
