  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="active"><a href="<?php echo base_url(); ?>Salon2/Admin/report_cashier">Report Cashier</a></li>
      </ul>
...
<body id="page-top" class="index">
     <div class="form-group">
      ...
      <div class="col-lg-11"><h3>Report Cashier</h3><h5 class="text-right"><?php echo "Time Server " . date("d F Y") . "<br>";?></h5>
		...
		<form name="formlist" method="post" action="<?php echo base_url(); ?>Salon2/Admin/list_transaksi_cashier">
