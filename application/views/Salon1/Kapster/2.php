...
<body id="page-top" class="index">
		<div class="col-lg-10"><h3>Start Selling</h3><h5 class="text-right"><?php echo "Time Server " . date("d F Y") . "<br>";?></h5><div class="box-body centerbox">
			...
			<option value=""></option>
				...
				?>
			</select></div><a href="<?php echo base_url(); ?>Salon1/Admin/register_produk"><button>+</button></a> </div>
			...
			<option value=""></option>
				...
				?>
			</select></div><?php echo "<a href='".site_url('Salon1/Admin/registerProduk/'."1")."')'><button>+</button></a> ";?></div>
			...
			<option value=""></option>
				...
				?>
			</select></div><?php echo "<a href='".site_url('Salon1/Admin/registerProduk/'."2")."')'><button>+</button></a> ";?></div>
			...
			<option value=""></option>
				...
				?>
			</select></div><?php echo "<a href='".site_url('Salon1/Admin/registerProduk/'."3")."')'><button>+</button></a> ";?></div>
            ...
            <div class="col-lg-10"><select class="form-control kapsterSelection" >
				...
				?>				
			</select></div><?php echo "<a href='".site_url('Salon1/Admin/registerProduk/'."4")."')'><button>+</button></a> ";?></div>
			<br>
...
function submitSell(e){
	...
	$.post("http://localhost/CI/Salon1/Admin/tambah_transaksi",
	{
