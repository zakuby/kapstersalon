  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="active"><a href="<?php echo base_url(); ?>Salon1/Admin/report_owner">Report Owner</a></li>
      </ul>
...
<body id="page-top" class="index">
     <div class="form-group">
	  ...
	  <h3>Report Kapster</h3><h5 class="text-right"><?php echo "Time Server " . date("d F Y") . "<br>";?></h5>
		...
		<form name="formlist" method="post" action="<?php echo base_url(); ?>Salon1/Admin/list_transaksi">
			<div class="form-group">
		...
		<table id="example2" class="table ">
            ...
            foreach ($t as $transaksi) {
                print "<tr>";
				print "<td>";
				print $transaksi->nama_cashier;
                print "<td>";
				print $transaksi->nama_kapster;
				print "<td>";
				...
				if($transaksi->rate_produk!=NULL){
					...
					print '<td>Rp. '. number_format( ($transaksi->harga * ($transaksi->rate_kapster/100)), 0 , '' , '.' ) .'</td>';
			...
			print '<td  class="table-danger borderless" colspan="5">Total</td><td>';
			echo 'Rp. ' . number_format( $total2, 0 , '' , '.' ) ; 
			print '</td><td colspan="2">'.$transaksi->rate_kapster .'%</td></tr>';
			print '<tr class="bg-black">';
			print '<td colspan="5">Gaji Kapster</td><td colspan="2">';
			echo 'Rp. ' . number_format( $total, 0 , '' , '.' ) ; 
			print '</td><td></td></tr>';
            ?></tbody></table><a href="<?php echo base_url(); ?>Salon1/Admin/createPDF" class="btn btn-primary pull-right" id="cmd"  target="_blank">Save PDF</a>
		</div>
      </div>
    </div>
</body>
