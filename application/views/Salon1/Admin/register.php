...
<body id="page-top" class="index">
     <div class="form-group">
      ...
      <div class="col-lg-11"><h3>Register Product</h3><h5 class="text-right"><?php echo "Time Server " . date("d F Y") . "<br>";?></h5><div class="box-body centerbox">
		...
		<div id="tujuan">
		<form method="post" action="<?php echo base_url(); ?>Salon1/Admin/tambah_kapster">
			<div class="form-group">
			...
			<label for="exampleInputPassword1" >Rate (%) </label><br>
				<input type="number" step=any class="form-control" name="rate" placeholder="" required>
			</div>
			<div class="form-group">
			<label for="exampleInputPassword1" >Rate Low(%) </label><br>
				<input type="number" step=any class="form-control" name="rate_low" placeholder="" required>
			</div>
