...
class MYPDF extends TCPDF {
  ...
  public function Header(){
     $html = '<b>Salon Kapster 1 <br>Gaji Kapster</b> <br><p style="border-bottom: 2px solid black;"></p>';
...
$tb1 .= '<br>Rate Cashier&nbsp;&nbsp;&nbsp;: '.$c[0]->rate_cashier.'%';
...
foreach($t as $transaksi){
	...
	if($transaksi->rate_produk!=NULL){
		...
		$tb1 .= '<td>'.$transaksi->rate_cashier .'%</td>';
		$tb1 .= '<td>Rp. '. number_format( ($transaksi->harga * ($transaksi->rate_cashier/100)), 0 , '' , '.' ) .'</td>';
...
$tb1 .= '<td bgcolor="#8e8d8d" colspan="2">'.$transaksi->rate_cashier .'%</td>';
$tb1 .=  '</tr>';
$tb1 .=  '<tr class="bg-black">';
$tb1 .=  '<td  bgcolor="#8e8d8d" colspan="3">Gaji Cashier</td>';
