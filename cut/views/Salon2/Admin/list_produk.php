...
<table id="example2" class="table table-bordered table-hover">
            ...
            foreach ($p as $produk) {
				...
				echo "<a href='".site_url('Salon2/Admin/editProduk/'.$produk->id_produk)."')'><button>Edit</button></a> ";
				echo "<a onClick=\"javascript: return confirm('Are you sure to delete ?');\" href='".site_url('Salon2/Admin/hapusProduk/'.$produk->id_produk)."')'><button>X</button></a>";
            }
            ?>
			                </tfoot>
              </table>
