  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>Salon2/Admin/report_kapster">Report Kapster</a></li>
...
<body id="page-top" class="index">
     <div class="form-group">
	  ...
	  <h3>Report Kapster</h3><h5 class="text-right"><?php echo "Time Server " . date("d F Y") . "<br>";?></h5>
		...
		<form name="formlist" method="post" action="<?php echo base_url(); ?>Salon2/Admin/list_transaksi">
			<label for="sel1">Nama Kapster</label> <br/>
            <select class="form-control" name="nama" id="asal"  >
			<option value="<?php echo $_SESSION["nama"]?>"><?php echo $t[0]->nama_kapster?></option>
			    <?php
		...
		<table id="example2" class="table ">
			...
			print '<tr class="bg-black">';
			print '<td colspan="3">Gaji Kapster</td><td colspan="2">';
			echo 'Rp. ' . number_format( $total, 0 , '' , '.' ) ; 
			print '</td><td></td></tr>';
            ?></tbody></table><a href="<?php echo base_url(); ?>Salon2/Admin/createPDF" class="btn btn-primary pull-right" id="cmd"  target="_blank">Save PDF</a>
		</div>
      </div>
    </div>
</body>
