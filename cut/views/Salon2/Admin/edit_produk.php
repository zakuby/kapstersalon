...
<body id="page-top" class="index">
     <div class="form-group">
	  ...
	  <div class="box-body centerbox">
			<?php
				foreach ($p as $produk) {
					echo "<form method='post' action='".site_url('Salon2/Admin/updateProduk/'.$produk->id_produk)."')'>";
				}
			?>
			...
			<div class="col-lg-1 pull-right">
				<a href="<?php echo base_url(); ?>Salon2/Admin/list_produks" class="btn btn-primary" >Cancel</a>
			</div>
		</form>
