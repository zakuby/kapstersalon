  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="<?php echo base_url(); ?>Salon2/cashier/logout">Logout</a></li>
      </ul>
    </div>
  </div>
</nav>
	  ...
	  <div class="box-body centerbox">
			<?php
				foreach ($c as $cashier) {
					echo "<form method='post' action='".site_url('Salon2/Admin/updateCashier/'.$cashier->id_cashier)."')'>";
				}
			?>
			...
			<div class="col-lg-1 pull-right">
				<a href="<?php echo base_url(); ?>Salon2/Admin/list_cashier" class="btn btn-primary" >Cancel</a>
			</div>
		</form>
